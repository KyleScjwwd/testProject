...
<div class="place">
    ...
    <ul class="placeul">
        ...
        <li><a href="#">系统管理</a></li>
        <li><a href="#">登记生产状态</a></li>
    </ul>
</div>
<div class="rightinfo">
    <form name="AddSignInForm" id="AddSignInForm" action="signInAction!addSignIn.action" method="post">
        <table class="tablelist">
                ...
                <td>
                    <select name="bhzCode" class="scinput" style="height: 25px">
                        ...
                        <c:forEach var="b" items="${BHZs}">
                            <option value="${b.bhzCode}" ${b.bhzCode==si.bhzCode?'selected':''}>${b.bhzName}</option>
                        </c:forEach>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" name="signInDate" value='<fmt:formatDate value="${si.signInDate}" pattern="yyyy-MM-dd"/>' class="scinput" style="height: 25px"
            ...
            <tr>
                <td colspan="2" align="center">
                    <input type="button" class="btn1" style="margin-left: 350px" onclick="si.CheckAdd();" value="添加"/>
