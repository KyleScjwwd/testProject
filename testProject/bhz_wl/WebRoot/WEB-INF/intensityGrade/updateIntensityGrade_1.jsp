...
<div class="all">
    <div class="scsj">
    <p>您当前的位置：<a href="javascript:;">拌合站监控系统 </a>&gt;&gt;<a href="javascript:;">系统管理</a>&gt;&gt;<a href="javascript:;">修改强度等级</a></p>
    </div>
       ...
       <!-- <tr>
            ...
            <tr>
                <td colspan="2" align="center">
                    <a href="#" class="bia" style="margin-left: 350px" onclick="intensityGrade.CheckUpdate();">修改</a>
