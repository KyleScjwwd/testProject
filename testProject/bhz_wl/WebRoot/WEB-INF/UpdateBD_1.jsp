...
<div class="all">
    <div class="scsj">
    <p>您当前的位置：<a href="javascript:;">拌合站监控系统 </a>&gt;&gt;<a href="javascript:;">系统管理</a>&gt;&gt;<a href="javascript:;">编辑标段</a></p>
    </div>
    ...
    <table class="bjdiv">
    	<tr>
            ...
            <td width="70%">
            <input type="text" name="bdCode" value="${bd.bdCode}" class="Fwidth" readonly="readonly"/>
            ...
            <tr>
                <td colspan="2" align="center">
                    <a href="javascript:;" class="bia" style="margin-left: 350px" onclick="bd.CheckAdd();">修改</a>
