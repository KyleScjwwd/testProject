...
<div class="all">
    <div class="scsj">
    <p>您当前的位置：<a href="javascript:;">拌合站监控系统 </a>&gt;&gt;<a href="javascript:;">系统管理</a>&gt;&gt;<a href="javascript:;">修改用户</a></p>
    </div>
    <%@ include file="base/sysLinked.jsp" %>
  <form name="AddUserForm" id="AddUserForm" action="UserAction!updateUser.action" method="post">
           ...
           <tr>
            ...
            <tr>
                <td colspan="2" align="center">
                    <a href="javascript:;" class="bia" style="margin-left: 350px" onclick="user.CheckAdd();">修改</a>
