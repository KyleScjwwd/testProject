...
<div class="all">
    <div class="scsj">
    	<p>您当前的位置：<a href="javascript:;">拌合站监控系统 </a>&gt;&gt;<a href="javascript:;">短信报警</a>&gt;&gt;<a href="javascript:;">修改报警人员基本信息</a></p>
    </div>
    <div class="list">
    ...
    <table class="bjdiv">
            ...
            <td width="70%">
	            <select name="bdCode" id="bd" class="Fwidth" onchange="showBhz();">
					...
					<c:forEach var="b" items="${bdList}">
						<option <c:if test="${p.bdCode eq b.bdCode}">selected="selected"</c:if> value="${b.bdCode}">${b.bdName}</option>
					</c:forEach>
				</select>
            </td>            
        </tr>
        ...
        <tr>
            <td colspan="2" align="center">
            	<a href="javascript:;" class="bia" style="margin-left: 350px" onclick="BjPersonBase.CheckAddOrUpdate('update');">保存</a>
