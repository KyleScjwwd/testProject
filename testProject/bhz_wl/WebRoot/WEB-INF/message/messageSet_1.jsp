                ...
                <c:choose>
						...
						<c:otherwise>
						  <tr>
						    ...
						    <td rowspan="3"><textarea rows="4" cols="60" name="msgContent-bht" type="_moz">${mainMap[mapKey1].msgContent}</textarea></td>
						    ...
						    <td><input type="text" style="width:60px" name="down-bht-0" value="${subMap[subKey].downValue}"/></td>
						    <td><input type="text" style="width:60px" name="up-bht-0" value="${subMap[subKey].upValue}"/></td>
						  </tr>
						  <tr>
						    ...
						    <td><input type="text" style="width:60px" name="down-bht-1" value="${subMap[subKey].downValue}"/></td>
						    <td><input type="text" style="width:60px" name="up-bht-1" value="${subMap[subKey].upValue}"/></td>
						  </tr>
						  <tr>
						    ...
						    <td><input type="text" style="width:60px" name="down-bht-2" value="${subMap[subKey].downValue}"/></td>
						    <td><input type="text" style="width:60px" name="up-bht-2" value="${subMap[subKey].upValue}"/></td>
						  </tr>
						  ...
						  <tr ${i.index%2==0?'bgcolor=#F0F0F0':''}>
						    ...
						    <td rowspan="3">
						    <input type="radio" name="isBaojing-${p.pname}" <c:if test="${mainMap[mapKey2].isBaojing eq '1'}">checked="checked"</c:if> value="1"/>报警
						    <input type="radio" name="isBaojing-${p.pname}" <c:if test="${mainMap[mapKey2].isBaojing eq '0'}">checked="checked"</c:if> value="0"/>不报警</td>
						    <td rowspan="3"><textarea rows="4" cols="60" name="msgContent-${p.pname}" type="_moz">${mainMap[mapKey2].msgContent}</textarea></td>
						    <td>初级(项目部)<c:set var="subKey" value="${mapKey2}-0"/><input type="hidden" name="sendType-${p.pname}-0" value="0"/></td>
						    <td>
						    <input type="button" value="选择" onclick="openPhoneDiv('mobile-${p.pname}-0');"/>
						    <input type="hidden" name="mobile-${p.pname}-0" value="${subMap[subKey].mobile}"/>
						    </td>
						    <td><input type="text" style="width:60px" name="down-${p.pname}-0" value="${subMap[subKey].downValue}"/></td>
						    <td><input type="text" style="width:60px" name="up-${p.pname}-0" value="${subMap[subKey].upValue}"/></td>
						  </tr>
						  <tr ${i.index%2==0?'bgcolor=#F0F0F0':''}>
						    <td>中级(监理)<c:set var="subKey" value="${mapKey2}-1"/><input type="hidden" name="sendType-${p.pname}-1" value="1"/></td>
						    <td>
						    <input type="button" value="选择" onclick="openPhoneDiv('mobile-${p.pname}-1');"/>
						    <input type="hidden" name="mobile-${p.pname}-1" value="${subMap[subKey].mobile}"/>
						    </td>
						    <td><input type="text" style="width:60px" name="down-${p.pname}-1" value="${subMap[subKey].downValue}"/></td>
						    <td><input type="text" style="width:60px" name="up-${p.pname}-1" value="${subMap[subKey].upValue}"/></td>
						  </tr>
						  <tr ${i.index%2==0?'bgcolor=#F0F0F0':''}>
						    <td>高级(指挥部)<c:set var="subKey" value="${mapKey2}-2"/><input type="hidden" name="sendType-${p.pname}-2" value="2"/></td>
						    <td>
						    <input type="button" value="选择" onclick="openPhoneDiv('mobile-${p.pname}-2');"/>
						    <input type="hidden" name="mobile-${p.pname}-2" value="${subMap[subKey].mobile}"/>
						    </td>
						    <td><input type="text" style="width:60px" name="down-${p.pname}-2" value="${subMap[subKey].downValue}"/></td>
						    <td><input type="text" style="width:60px" name="up-${p.pname}-2" value="${subMap[subKey].upValue}"/></td>
						  </tr>
						  </c:forEach>
						</c:otherwise>
				</c:choose>
