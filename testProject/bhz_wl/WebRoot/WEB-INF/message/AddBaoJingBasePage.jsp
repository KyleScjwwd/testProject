...
<div class="rightinfo">
    <form id="AddBaoJingBaseForm" action="messageAction!addBaoJingBase.action" method="post">
        <table class="tablelist">
            ...
            <tr>
                <td align="right">短信内容水泥值-C不在范围内（-C将替换为实际值）：</td>
                <td><textarea rows="4" cols="60" name="msgContent">${b.msgContent}</textarea></td>
            </tr>
            <tr>
                <td align="right">发送级别-初级（项目部）：</td>
                <td>
            ...
            <tr>
                <td colspan="2" align="center">
                    <input type="button" class="btn1" style="margin-left: 350px" onclick="BjBase.CheckAdd();" value="添加"/>
