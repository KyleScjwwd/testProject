...
public class PropertyReader {
	 ...
	 * @param propertyFilePath属性文件路径(包括类路径或文件系统中文件路径)
	 * @param key属性的键
	...
	/**
	 * 方法用途和描述: 获得属性文件的属性
	 * @param propertyFilePath属性文件(包括类路径)
	 * @return 属性
	 */
	...
	/**
	 * 方法用途和描述: 获得属性文件的属性
	 * @param propertyFilePath属性文件路径(包括类路径及文件系统路径)
	 ...
	 * 
	 * 方法用途和描述: 从文件系统加载属性文件
	 * @param propertyFilePath属性文件(文件系统的文件路径)
	 * @return 属性
	 */
	 ...
	 * @param propertyFilePath属性文件的路径(包括类路径及文件系统路径)
	 * @param htKeyValue键值对Hashtable
	 */
	 ...
	 * 
	 * 方法用途和描述: 创建属性文件
	 * @param propertyFilePath要存储属性文件的路径
	 * @param htKeyValue属性文件中的键值对Hashtable
	 * @return
	 */
	...
	/**
	 * 方法用途和描述: 保存属性文件对象
	 * @param properties属性文件对象
	 * @param propertyFilePath要保存的路径
	 */
	 ...
	 * @param propertyFilePath属性文件路径(包括类路径及文件系统路径)
	 * @param htKeyValue要更新的键值对Hashtable
	 * @return 成功与否（true|false）
	 */
	 ...
	 * @param propertyFilePath要重新加载的Property文件，如果当前内存中没有的话则加载，否则替换
	 */
	...
	public static void main(String[] args) {
		String path = "/config/custGroupId.properties";
		String v = PropertyReader.getValue(path, "name");
		_log.info("value0 = " + v);
